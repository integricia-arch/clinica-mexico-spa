...
| **3** | **S1 rate limiting Edge Functions** | **Opus 4.8 diseño, Sonnet implementa** | **⬅️ SIGUIENTE** |
| 4 | N3 unit economics + N2 pricing + N4 matriz tiers | Fable 5 | pendiente (1 sesión negocio) |

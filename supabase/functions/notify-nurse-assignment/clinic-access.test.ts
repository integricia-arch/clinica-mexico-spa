...
// Regresion que este test protege: cualquier usuario autenticado (sin
// verificar rol ni clinica) podia disparar notify-nurse-assignment para una
// cita de otra clinica solo conociendo el appointment_id. Ver

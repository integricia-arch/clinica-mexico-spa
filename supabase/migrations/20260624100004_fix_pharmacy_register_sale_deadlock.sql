...
-- Problema: FOR UPDATE en loop sobre lotes en orden arbitrario de p_payload['items'] → deadlock bajo concurrencia.
-- Solución: pre-lock todos los lotes necesarios en ORDER BY id antes de los dos loops existentes.

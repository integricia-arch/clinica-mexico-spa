...
-- CONCURRENTLY removido: Supabase CLI no lo soporta.

BEGIN;

-- lotes_medicamento: idx_lotes_medicamento es prefijo de idx_lotes_fifo
DROP INDEX IF EXISTS public.idx_lotes_medicamento;
DROP INDEX IF EXISTS public.idx_lotes_med;

-- movimientos_inventario: idx_movimientos_medicamento es prefijo de idx_movs_med
DROP INDEX IF EXISTS public.idx_movimientos_medicamento;

-- journey_instance_steps: idx_jis_journey es prefijo de idx_jis_journey_key
DROP INDEX IF EXISTS public.idx_jis_journey;

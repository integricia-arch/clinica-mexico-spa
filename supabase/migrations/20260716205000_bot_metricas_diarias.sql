-- Vista: bot_metricas_diarias
-- Agregación diaria de métricas del bot Telegram

CREATE OR REPLACE VIEW public.bot_metricas_diarias AS
SELECT
...
COMMENT ON VIEW public.bot_metricas_diarias IS 'Métricas diarias del bot Telegram: conversaciones activas, citas creadas, escaladas y pacientes nuevos registrados por el bot';

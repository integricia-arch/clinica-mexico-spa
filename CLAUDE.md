...
- **`crear_poliza()` en prod perdió el bypass de `auth.uid() IS NULL` que fase 6B documentó a propósito para cron/service_role — bloqueante, sin arreglar.** Ver `project_crear-poliza-perdio-bypass-service-role.md` en memoria — es prioridad #1 antes de tocar cualquier otra cosa contable. <!-- /aprende 2026-07-21 -->
